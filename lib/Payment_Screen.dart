...
class Patment extends StatefulWidget {
  @override
  final  data;
  Patment({Key key, this.data}) : super(key: key);
  State<StatefulWidget> createState() => payment(data);
}
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: OutlineButton(
                            ...
                            onPressed: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=> card_details()));
                            },
