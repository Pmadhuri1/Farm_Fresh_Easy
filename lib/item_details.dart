            ...
            child:SingleChildScrollView(
             ...
             Container(
                 padding: const EdgeInsets.fromLTRB(20.0, 10.0, 10.0, 0.0),
                          ...
                          child: Text("This product os from Ramaiah's from located in nizamabad this farm is checked and then accepted by the admin.For any further Queries please Reach out through the mail farmeasy@gmail.com or contact the number +919293944955. Thank You for buying from us you not only get qualitied food you also in other  way help farmers to get better price from their crop and it helps them in many ways.",
                            maxLines: 10,
